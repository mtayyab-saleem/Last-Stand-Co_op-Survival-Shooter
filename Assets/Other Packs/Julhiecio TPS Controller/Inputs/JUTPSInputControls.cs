...
//     version 1.17.0
//     from Assets/Other Packs/Julhiecio TPS Controller/Inputs/JUTPSInputControls.inputactions
//
...
{
    /// <summary>
    /// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Other Packs/Julhiecio TPS Controller/Inputs/JUTPSInputControls.inputactions".
    /// </summary>
    /// <remarks>
    ...
    public partial class @JUTPSInputControls: IInputActionCollection2, IDisposable
    {
        ...
        /// </summary>
        public @JUTPSInputControls()
        {
            asset = InputActionAsset.FromJson(@"{
    ""version"": 1,
    ""name"": ""JUTPSInputControls"",
    ""maps"": [
        {
            ""name"": ""Player"",
    ...
    ""controlSchemes"": [
        ...
        ~@JUTPSInputControls()
        {
            UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, JUTPSInputControls.Player.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, JUTPSInputControls.UI.Disable() has not been called.");
        }
