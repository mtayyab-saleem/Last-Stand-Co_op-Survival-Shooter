...
namespace JUTPS.CameraSystems
{
    ...
    public class TPSCameraController : JUCameraController
    {
        ...
        protected override void Start()
        {
            ...
            if (TargetToFollow != null && TargetToFollow.TryGetComponent(out JUCharacterController JUcharacter))
            {
        ...
        {
            // Early exit if essential references are destroyed
            ...
            if (FollowUpTarget)
            {
                ...
                if (characterTarget != null && characterTarget.transform != null)
                {
                    upward = characterTarget.transform.up;
                }
                else if (TargetToFollow != null)
                {
                    upward = TargetToFollow.up;
                }
                RotateCamera(xmouse, ymouse, upward: upward);
            }
            else
            {
